...
public class ButtonListener implements Listener {
    ...
    public void onButtonPress(InventoryClickEvent event) {
        ...
        AbstractMenu openMenu = AbstractMenu.currentlyOpenedMenus.get(player.getUniqueId());
        ...
        if (openMenu != null) {
            ...
            if (openMenu.getButtons().containsKey(event.getSlot())) {
                ...
                if (AbstractMenu.currentlyOpenedMenus.containsKey(player.getUniqueId())) {
                    AbstractMenu newMenu = AbstractMenu.currentlyOpenedMenus.get(player.getUniqueId());
                ...
                if (event.isCancelled()) {
                    Bukkit.getScheduler().runTaskLater(Utils.getJavaPlugin(), player::updateInventory, 1L);
                }
            } else {
                if (event.getCurrentItem() != null) {
                    event.setCancelled(true);
    ...
    public void onInventoryClose(InventoryCloseEvent event) {
        ...
        if (openMenu != null) {
            ...
            AbstractMenu.currentlyOpenedMenus.remove(player.getUniqueId());
        }
    }
